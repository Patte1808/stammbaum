...
public class Person {
    ...
    public void setSpouse(Person spouse) {
        if(spouse==null) throw new IllegalArgumentException("cannot devorce people");
        else if(this.existingCycle(spouse)||spouse.existingCycle(this)) throw new IllegalArgumentException("existing cycle");
    ...
    public List<Person> getParents() {
        List<Person> returnList = new ArrayList<Person>();
        returnList.addAll(getFather());
        returnList.addAll(getMother());
        return returnList;
    }
    /**
    ...
    public void setParent(Person parent) {
        ...
        if(children.contains(parent)) throw new IllegalArgumentException("existing cycle");
    ...
    public void setChildren(Person child) {
        ...
        else if(child.equals(this.spouse)) throw new IllegalArgumentException("existing cycle");
        else if(this.existingCycle(child)) throw new IllegalArgumentException("existing cycle");
        if(spouse != null) {
            if(spouse.getChildren().contains(child)) throw new IllegalArgumentException("children already exists");
        }
        if(this.children.contains(child)) throw new IllegalArgumentException("children already exists");
        children.add(child);
    ...
    /**
     * proofs whether a person is already higher in the family tree than the actual person
     * @param person to proof
     * @return true if person already exists
     */
    private boolean existingCycle(Person person) {
        if(person != null) {
